...
namespace App\UI\Bonus\Controller\Get;

use App\Application\Bonus\UseCase\BonusGetAction;
...
class Controller extends AbstractController
{
    public function __construct(
        private readonly BonusGetAction      $bonusGetAction,
    ...
    public function __invoke(int $userId, Request $request): JsonResponse
    {
        ...
        try {
            $bonus = $this->bonusGetAction->do($userId);
