...
namespace App\UI\Account\Controller\Get;

use App\Application\Account\UseCase\AccountGetAction;
...
class Controller extends AbstractController
{
    public function __construct(
        private readonly AccountGetAction    $accountGetAction,
    ...
    public function __invoke(int $userId, Request $request): JsonResponse
    {
        ...
        try {
            $account = $this->accountGetAction->do($userId);
