...
#[ORM\UniqueConstraint(name: "UNIQ_moderKey", columns: ["moder_key"])]
class Advertisement implements AdvertisementModelInterface
{
    ...
    private ?string $moderKey = null;

    #[ORM\Column(length: 255, nullable: true)]
    private ?string $moderFailReason = null;
