...
namespace App\UI\Advertisement\Controller\Publish;

use App\Application\Advertisement\UseCase\AdvertisementPublishAction;
use App\Application\Kafka\Exception\ProducerException;
use App\UI\Advertisement\Controller\Publish\Dto\AdvertisementPublishDto;
...
class Controller extends AbstractController
{
    public function __construct(
        ...
        private readonly AdvertisementPublishAction $advertisementPublishAction,
    ...
    */
    public function __invoke(int $advId, Request $request): JsonResponse
    {
        ...
        $input = new AdvertisementPublishDto($auth, $advId);

        try {
            $advertisement = $this->advertisementPublishAction->do($input);
