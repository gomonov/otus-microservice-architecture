...
namespace App\UI\Advertisement\Controller\UnArchive;

use App\Application\Advertisement\UseCase\AdvertisementUnArchiveAction;
use App\UI\Advertisement\Controller\UnArchive\Dto\AdvertisementUnArchiveDto;
...
class Controller extends AbstractController
{
    public function __construct(
        ...
        private readonly AdvertisementUnArchiveAction $advertisementUnArchiveAction,
    ...
    public function __invoke(int $advId, Request $request): JsonResponse
    {
        ...
        $input = new AdvertisementUnArchiveDto($auth, $advId);

        try {
            $advertisement = $this->advertisementUnArchiveAction->do($input);
