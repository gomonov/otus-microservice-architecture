...
namespace App\UI\Account\Controller\Pay;

use App\Application\Account\UseCase\AccountPayAction;
...
class Controller extends AbstractController
{
    public function __construct(
        ...
        private readonly AccountPayAction                 $accountPayAction,
    ...
    public function __invoke(int $userId, Request $request): JsonResponse
    {
        ...
        try {
            $account = $this->accountPayAction->do($input);
