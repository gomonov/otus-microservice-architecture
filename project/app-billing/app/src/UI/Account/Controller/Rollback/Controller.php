...
namespace App\UI\Account\Controller\Rollback;

use App\Application\Account\UseCase\AccountRollbackAction;
use App\Application\Exception\AbstractApplicationException;
use App\UI\Account\Controller\Rollback\Dto\AccountRollbackDto;
...
class Controller extends AbstractController
{
    public function __construct(
        ...
        private readonly AccountRollbackAction            $accountRollbackAction,
    ...
    public function __invoke(int $userId, Request $request): JsonResponse
    {
        ...
        $input = new AccountRollbackDto($userId, $request);
        ...
        try {
            $account = $this->accountRollbackAction->do($input);
            $output  = new AccountOutputData($account);
